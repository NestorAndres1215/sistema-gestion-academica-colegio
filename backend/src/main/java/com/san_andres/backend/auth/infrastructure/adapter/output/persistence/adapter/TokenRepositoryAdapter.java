...
import com.san_andres.backend.auth.infrastructure.adapter.output.persistence.entity.TokenEntity;
import com.san_andres.backend.auth.infrastructure.adapter.output.persistence.mapper.TokenMapper;
import com.san_andres.backend.auth.infrastructure.adapter.output.persistence.projection.TokenStatusProjection;
import com.san_andres.backend.auth.infrastructure.adapter.output.persistence.repository.JpaTokenRepository;
