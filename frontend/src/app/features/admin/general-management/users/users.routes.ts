...
export const USERS_ROUTES: Routes = [
  ...
  {
    path: 'estado-cuenta',
    loadComponent: () => import('./user-status/user-status').then((m) => m.UserStatus),
  },
  {
    path: 'busqueda',
    loadComponent: () =>
      import('./user-advanced-search/user-advanced-search').then((m) => m.UserAdvancedSearch),
  },
  {
    path: 'reporte',
  ...
  {
    path: 'importar',
    loadComponent: () => import('./user-import/user-import').then((m) => m.UserImport),
  },
  {
